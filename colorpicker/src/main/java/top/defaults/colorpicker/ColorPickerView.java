...
public class ColorPickerView extends LinearLayout implements ColorObservable {
    ...
    public ColorPickerView(Context context, @NonNull AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ColorPickerView(Context context, @NonNull AttributeSet attrs, int defStyleAttr) {
    ...
    public void setSelectorColor(int color) {
        brightnessSliderView.setSelectorColor(color);
        alphaSliderView.setSelectorColor(color);
    }
}

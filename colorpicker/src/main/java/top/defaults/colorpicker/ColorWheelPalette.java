...
public class ColorWheelPalette extends View {
    ...
    public ColorWheelPalette(Context context, @NonNull AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ColorWheelPalette(Context context, @NonNull AttributeSet attrs, int defStyleAttr) {

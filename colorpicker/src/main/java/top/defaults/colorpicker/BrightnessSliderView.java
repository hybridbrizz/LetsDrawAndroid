...
public class BrightnessSliderView extends ColorSliderView {
    ...
    public BrightnessSliderView(Context context, @NonNull AttributeSet attrs) {
        super(context, attrs);
    }

    public BrightnessSliderView(Context context, @NonNull AttributeSet attrs, int defStyleAttr) {

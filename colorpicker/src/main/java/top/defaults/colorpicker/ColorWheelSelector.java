...
public class ColorWheelSelector extends View {
    ...
    public ColorWheelSelector(Context context, @NonNull AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ColorWheelSelector(Context context, @NonNull AttributeSet attrs, int defStyleAttr) {

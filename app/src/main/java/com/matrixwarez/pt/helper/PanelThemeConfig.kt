    ...
    companion object {
        fun buildConfig(textureResId: Int): PanelThemeConfig {
            when (textureResId) {
                ...
                R.drawable.water_texture -> return defaultLightTheme()
                ...
                R.drawable.rainbow_foil -> return defaultDarkTheme()
                ...
                R.drawable.crystal_4 -> return defaultLightTheme()
                R.drawable.crystal_5 -> return defaultDarkTheme()
                R.drawable.crystal_6 -> return defaultDarkTheme()
                ...
                R.drawable.grass -> return defaultDarkTheme()
                ...
                R.drawable.amb_13 -> return defaultLightTheme()
                R.drawable.amb_14 -> return defaultLightTheme()
                R.drawable.amb_15 -> return defaultLightTheme()
            }

...
class TermsOfServiceFragment: Fragment() {
    ...
    private val termsOfService = "Terms of Service\n\n" +
            "This software, “service” or “app” is provided by Matrix Warez Ltd. (\"developer\", \"publisher\") as is, whereby any feature, bug or issue with the app is not the responsibility of the developers or publishers of the service to withhold or upkeep. You must be at least 13 years of age to use this service.\n\n" +

...
import com.ericversteeg.radiofrost.activity.InteractiveCanvasActivity
...
class TermsOfServiceFragment: Fragment() {
    ...
    private val termsOfService = "Terms of Service\n\n" +
            ...
            "(3) Copied Content\n" +
            "Within the app any person may choose to select, export, and share any number of pixels that together make up an image that may or may not contain sensitive, offensive, or copyrighted content, or content depicting hateful acts or speech. Please note that once content (pixels) are exported from the app, as soon as those pixels in the form of an image leave the app via a file stored on a person's device or shared via text or another app or service, that it is no longer the responsibility of the developers or publishers of this app and that while they give their best effort to tend to copyright notices and other claims, sometimes they will not get to it in time before it is copied over and leaves the app.\n\n" +
